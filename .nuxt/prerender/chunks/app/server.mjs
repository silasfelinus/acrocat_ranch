...
import { getContext, executeAsync } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION, RouterView } from 'file:///home/silasfelinus/code/kindrobots/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode, setCookie, getCookie, deleteCookie } from 'file:///home/silasfelinus/code/kindrobots/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, joinURL, withoutTrailingSlash, withLeadingSlash, withBase } from 'file:///home/silasfelinus/code/kindrobots/node_modules/ufo/dist/index.mjs';
...
import { getActiveHead, createServerHead as createServerHead$1 } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/silasfelinus/code/kindrobots/node_modules/@unhead/shared/dist/index.mjs';
import { hash, isEqual } from 'file:///home/silasfelinus/code/kindrobots/node_modules/ohash/dist/index.mjs';
import { parse } from 'file:///home/silasfelinus/code/kindrobots/node_modules/cookie-es/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///home/silasfelinus/code/kindrobots/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-01b7f22a.mjs').then((m) => m.default || m)
  }
];
...
const LazyAmiButterfly = defineAsyncComponent(() => import('./_nuxt/AmiButterfly-4fc3624e.mjs').then((r) => r.default));
const LazyAmiLink = defineAsyncComponent(() => import('./_nuxt/AmiLink-07caad78.mjs').then((r) => r.default));
const LazyAmiLink2 = defineAsyncComponent(() => import('./_nuxt/AmiLink2-46b2d07e.mjs').then((r) => r.default));
const LazyAmiSwarm = defineAsyncComponent(() => import('./_nuxt/AmiSwarm-3567d66c.mjs').then((r) => r.default));
const LazyBotCard = defineAsyncComponent(() => import('./_nuxt/BotCard-51d31683.mjs').then((r) => r.default));
const LazyBotChoose = defineAsyncComponent(() => import('./_nuxt/BotChoose-3f56002d.mjs').then((r) => r.default));
const LazyBotGallery = defineAsyncComponent(() => import('./_nuxt/BotGallery-3f4392e0.mjs').then((r) => r.default));
const LazyBotManager = defineAsyncComponent(() => import('./_nuxt/BotManager-de2ea79c.mjs').then((r) => r.default));
const LazyBotPrompt = defineAsyncComponent(() => import('./_nuxt/BotPrompt-f8e80adc.mjs').then((r) => r.default));
const LazyBotSpinner = defineAsyncComponent(() => import('./_nuxt/BotSpinner-221a0450.mjs').then((r) => r.default));
const LazyButtonCard = defineAsyncComponent(() => import('./_nuxt/ButtonCard-ce50d422.mjs').then((r) => r.default));
const LazyCardNavigation = defineAsyncComponent(() => import('./_nuxt/CardNavigation-dd6f111c.mjs').then((r) => r.default));
const LazyDreamStatus = defineAsyncComponent(() => import('./_nuxt/DreamStatus-99e6c86b.mjs').then((r) => r.default));
const LazyGallerySelect = defineAsyncComponent(() => import('./_nuxt/GallerySelect-381b1e36.mjs').then((r) => r.default));
const LazyGalleryViewer = defineAsyncComponent(() => import('./_nuxt/GalleryViewer-b714dc1a.mjs').then((r) => r.default));
const LazyGameScreen = defineAsyncComponent(() => import('./_nuxt/GameScreen-360c6272.mjs').then((r) => r.default));
const LazyImageNav = defineAsyncComponent(() => import('./_nuxt/ImageNav-b6bfeb65.mjs').then((r) => r.default));
const LazyNuxtLoadingBar = defineAsyncComponent(() => Promise.resolve().then(function() {
  return NuxtLoadingBar;
}).then((r) => r.default));
const LazyPageContent = defineAsyncComponent(() => import('./_nuxt/PageContent-105475a1.mjs').then((r) => r.default));
const LazyPageList = defineAsyncComponent(() => import('./_nuxt/PageList-e885d085.mjs').then((r) => r.default));
const LazySideNav = defineAsyncComponent(() => import('./_nuxt/SideNav-0893c528.mjs').then((r) => r.default));
const LazySiteFooter = defineAsyncComponent(() => import('./_nuxt/SiteFooter-6759f049.mjs').then((r) => r.default));
const LazySiteHeader = defineAsyncComponent(() => import('./_nuxt/SiteHeader-465dad4e.mjs').then((r) => r.default));
const LazySiteLogo = defineAsyncComponent(() => import('./_nuxt/SiteLogo-ce2e927b.mjs').then((r) => r.default));
const LazySiteTitle = defineAsyncComponent(() => import('./_nuxt/SiteTitle-b14690e6.mjs').then((r) => r.default));
const LazySubmissionForm = defineAsyncComponent(() => import('./_nuxt/SubmissionForm-747a716c.mjs').then((r) => r.default));
const LazyThemeChange = defineAsyncComponent(() => import('./_nuxt/ThemeChange-6617d867.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-6c915911.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-8a54dc65.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-3140150f.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-e793a67e.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-c210c108.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-231c0d81.mjs').then((r) => r.default));
...
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-fb8d9e82.mjs').then((r) => r.default));
...
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-0e7b53b9.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-924bf287.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-ba977761.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-e9d55f37.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-fd7edc9f.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-9aab3bcc.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-bc4b0be8.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-76f477ec.mjs').then((r) => r.default));
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-7bbb354a.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-873308bf.mjs').then((r) => r.default));
const lazyGlobalComponents = [
  ...
  ["BotCard", LazyBotCard],
  ["BotChoose", LazyBotChoose],
  ["BotGallery", LazyBotGallery],
  ["BotManager", LazyBotManager],
  ["BotPrompt", LazyBotPrompt],
  ["BotSpinner", LazyBotSpinner],
  ["ButtonCard", LazyButtonCard],
  ["CardNavigation", LazyCardNavigation],
  ["DreamStatus", LazyDreamStatus],
  ["GallerySelect", LazyGallerySelect],
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./_nuxt/client-db-e31c3c3a.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./_nuxt/client-db-e31c3c3a.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-d702a380.mjs').then((m) => m.default || m)),
  error: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-f672f117.mjs').then((m) => m.default || m)),
  gamescreen: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/gamescreen-378dc06d.mjs').then((m) => m.default || m)),
  resume: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/resume-46acb214.mjs').then((m) => m.default || m)),
  threecolumns: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/threecolumns-bcd96e0a.mjs').then((m) => m.default || m)),
  welcome: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/welcome-b2b6c878.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-cca166df.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0 as a, useRouter as b, createError as c, useRoute as d, entry$1 as default, useRuntimeConfig as e, useContentPreview as f, useNuxtApp as g, defineStore as h, useState as i, defineAppConfig as j, useRequestFetch as k, useContent as l, fetchContentNavigation as m, navigateTo as n, useUnwrap as o, get as p, queryContent as q, assertArray as r, ensureArray as s, sortList as t, useHead as u, apply as v, withoutKeys as w, withKeys as x, createQuery as y };
