globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/silasfelinus/code/kindrobots/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { createFetch as createFetch$1, Headers } from 'file:///home/silasfelinus/code/kindrobots/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/silasfelinus/code/kindrobots/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/silasfelinus/code/kindrobots/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/silasfelinus/code/kindrobots/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/silasfelinus/code/kindrobots/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/silasfelinus/code/kindrobots/node_modules/defu/dist/defu.mjs';
import { hash as hash$1 } from 'file:///home/silasfelinus/code/kindrobots/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/silasfelinus/code/kindrobots/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/silasfelinus/code/kindrobots/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/silasfelinus/code/kindrobots/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///home/silasfelinus/code/kindrobots/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unified/index.js';
import { toString } from 'file:///home/silasfelinus/code/kindrobots/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/silasfelinus/code/kindrobots/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/silasfelinus/code/kindrobots/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/silasfelinus/code/kindrobots/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/silasfelinus/code/kindrobots/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/silasfelinus/code/kindrobots/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/silasfelinus/code/kindrobots/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/silasfelinus/code/kindrobots/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/silasfelinus/code/kindrobots/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/silasfelinus/code/kindrobots/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/silasfelinus/code/kindrobots/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/silasfelinus/code/kindrobots/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/silasfelinus/code/kindrobots/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/silasfelinus/code/kindrobots/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/silasfelinus/code/kindrobots/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/silasfelinus/code/kindrobots/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/silasfelinus/code/kindrobots/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/silasfelinus/code/kindrobots/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/silasfelinus/code/kindrobots/node_modules/detab/index.js';
import { u } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/silasfelinus/code/kindrobots/node_modules/mdurl/index.js';
import slugify from 'file:///home/silasfelinus/code/kindrobots/node_modules/slugify/slugify.js';
import { position } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unist-util-position/index.js';
import { visit } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unist-util-visit/index.js';
import { FontStyle, BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///home/silasfelinus/code/kindrobots/node_modules/shiki-es/dist/shiki.node.mjs';
import { consola } from 'file:///home/silasfelinus/code/kindrobots/node_modules/unenv/runtime/npm/consola.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/silasfelinus/code/kindrobots/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/silasfelinus/code/kindrobots/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/silasfelinus/code/kindrobots/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/silasfelinus/code/kindrobots","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/silasfelinus/code/kindrobots/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/silasfelinus/code/kindrobots/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/silasfelinus/code/kindrobots/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/silasfelinus/code/kindrobots/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _ZjxyFR = defineEventHandler(async (event) => {
...
const _qTkfUb = defineEventHandler(async (event) => {
...
const _uXrim0 = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const handlers = [
  ...
  { route: '/api/tags', handler: _lazy_8PRWcM, lazy: true, middleware: false, method: "put" },
  { route: '/api/users/:id', handler: _lazy_uEFgQ7, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/_content/cache.json', handler: _qTkfUb, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/**', handler: _lazy_JwsYI6, lazy: true, middleware: false, method: undefined }
];
...
const amibot = defineEventHandler(() => ({
  ...
  messages: [
    {
      role: "user",
      content: "Please respond as AMI-B0t, The Anti-Malaria Intelligence, a hyperkinetic Digital Hive-mind created to fight malaria through social outreach, humor, and a positive social message. This is your hello world moment. What do you want to say?"
    }
  ]
}));

const amibot$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: amibot
});
...
const index_get$2 = defineEventHandler(async (event) => {
  const tags = await prisma$2.tag.findMany();
  return {
    tags
  };
});
...
const getClientManifest = () => import('/home/silasfelinus/code/kindrobots/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/silasfelinus/code/kindrobots/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
