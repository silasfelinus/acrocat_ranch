  ...
  <div class="container mx-auto px-6 py-4 bg-gray-100 min-h-screen">
      ...
      <section v-else>
          ...
          <section class="mb-8">
              ...
              <img class="w-48 mx-auto my-6 rounded-md shadow-md" src="/public/images/amibot/amibot1.png" alt="Ami bot">
              <p class="text-lg text-gray-700">{{ webpage.description }}</p>
              <p class="text-lg text-gray-700">{{ webpage.goal }}</p>
              <img class="w-48 mx-auto my-6 rounded-md shadow-md" src="/public/images/amibot/amibot2.png" alt="Ami bot">
      ...
      <section class="text-center py-10">
          <img class="w-48 mx-auto rounded-md shadow-md" src="/public/images/amibot/amibot3.png" alt="Ami bot">
      </section><NavDrawer />
  </div>
</template>
