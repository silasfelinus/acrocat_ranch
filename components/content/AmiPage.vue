<template>
  <div class="container mx-auto px-6 py-4 bg-gray-100 min-h-screen">
    ...
    <section v-else>
      <!-- Welcome Section -->
      <section class="mb-8">
        <h1 class="text-4xl mb-4 font-bold text-blue-800">
          {{ webpage.welcome_message }}
        </h1>
        <p class="text-lg text-gray-700">{{ webpage.mission_statement }}</p>
        <img
          class="w-48 mx-auto my-6 rounded-md shadow-md"
          src="/public/images/amibot/amibot1.png"
          alt="Ami bot"
        />
    ...
    <section class="text-center py-10">
      <img
        class="w-48 mx-auto rounded-md shadow-md"
        src="/public/images/amibot/amibot3.png"
        alt="Ami bot"
      />
    </section>
    <NavDrawer />
